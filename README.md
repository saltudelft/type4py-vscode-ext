...
3. Depending on the file size, after a couple of seconds, you can see the in-progress/completed requests at the bottom left of VSCode. <img src="images/status-bar.png" alt="Type4Py's status bar" width="100"/>
